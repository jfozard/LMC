...
import tifffile
import xmltodict
from mynetwork_local import MyNetWork
import torch
import time
...
def run():
    ...
    #Load the network
    model = MyNetWork("/data/LMC_train/LMC/maxvit/model_and_optimizer_100.pth", RESOURCE_PATH / "output_tubulin_model_and_optimizer_300.pth")
#    model = MyNetWork(RESOURCE_PATH / "ckpt.pth", RESOURCE_PATH / "output_tubulin_model_and_optimizer_300.pth")
